...
docker stack deploy -c docker-compose.tinaandcarlton.hawaiitest.yml renderws
docker stack deploy -c docker-compose.traefik.yml -c docker-compose.tinaandcarlton.hawaii.yml renderws
docker stack deploy -c docker-compose.traefik.yml -c docker-compose.tinaandcarlton.hawaii.yml -c docker-compose.tinaandcarlton.yml renderws
